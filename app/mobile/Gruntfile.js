// Generated on 2013-10-01 using generator-mobile 0.0.2
'use strict';
...
module.exports = function (grunt) {
    ...
    grunt.initConfig({
        ...
        open: {
            server: {
                path: 'http://localhost:<%= connect.options.port %>/app.html'
            }
                ...
                files: [
                    {
                        ...
                        cwd:'<%= yeoman.dist %>',
                        src: '**',
                        dest: '<%= yeoman.dist %>_<%= grunt.option(\"now\") %>'
                    }
                ]
            }
        },
...
//                },
    ...
    grunt.registerTask('build', 'Build dist', function(){
        grunt.option("now", Date.now());
        grunt.task.run([
            'copy:backup',
            'clean:dist',
            'less:dev',
    ...
    grunt.registerTask('backup', 'Backup of /dist', function(){
